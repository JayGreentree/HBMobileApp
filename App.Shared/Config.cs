    ...
    namespace Shared
    {
        ...
        namespace Config
        {
            public class GeneralConfig
            {
                ...
                /// </summary>
                public const string FBAppID = "1529459400688064";
                ...
                /// </summary>
                #if DEBUG
                public const string RockBaseUrl = "http://higherbound.org/";
                #else
                public const string RockBaseUrl = "http://rock.higherbound.org/";
                #endif
                ...
                /// </summary>
                public const string RockMobileAppAuthorizationKey = "l4Mj3iXhJqCKiQEcuNamnmiz";

                /// <summary>
                /// The base URL to look for Notes.
                /// </summary>
                public const string NoteBaseURL = "http://higherbound.org/content/mobileapp/";
                ...
                public static string [] DefaultNews_A =
                    {
                        ...
                        // Reference URL
                        "http://higherbound.org/ma-baptism",
                ...
                public static string [] DefaultNews_B =
                    {
                        ...
                        // Reference URL
                        "http://higherbound.org/ma-startingpoint",
            ...
            public class ConnectConfig
            {
                public static string[] GetStartedList = 
                    {
                        "Starting Point", "Begin your journey at CCV", "http://higherbound.org/ma-startingpoint", "starting_point_thumb.png",
                        "Baptisms", "Make your faith public", "http://higherbound.org/ma-baptism", "baptism_thumb.png"
                    };
                ...
                public static string[] GetEngagedList = 
                    {
                        ...
                        "Serve", "Give back by volunteering", "http://higherbound.org/ma-serve", "serve_thumb.png"
                    };
            ...
            public class GiveConfig
            {
                ...
                /// </summary>
                public const string GiveUrl = "http://higherbound.org/ma-give";
            }
            ...
            public class AboutConfig
            {
                ...
                /// </summary>
                public const string Url = "http://higherbound.org/ma-more";
            }
        }
    }
}
